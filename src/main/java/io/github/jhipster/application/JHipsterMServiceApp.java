...
public class JHipsterMServiceApp {

    private static final Logger log = LoggerFactory.getLogger(JHipsterMServiceApp.class);

    private final Environment env;

    public JHipsterMServiceApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jHipsterMServiceApp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JHipsterMServiceApp.class);
